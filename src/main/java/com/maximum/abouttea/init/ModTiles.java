...
public class ModTiles {
    public static final RegistryObject<TileEntityType<TileTeaSet>> TEA_SET_TILE = RegistryUtil.registryTile("teaset",()->TileEntityType.Builder.create(TileTeaSet::new,ModBlock.blockTeaSet.get()).build(null));
